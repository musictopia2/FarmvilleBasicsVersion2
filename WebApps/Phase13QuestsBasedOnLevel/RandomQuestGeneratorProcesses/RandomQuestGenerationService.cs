...
namespace Phase13QuestsBasedOnLevel.RandomQuestGeneratorProcesses;

public class RandomQuestGenerationService : IQuestGenerationService
{
    ...
    public RandomQuestGenerationService()
    {
